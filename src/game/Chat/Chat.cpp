...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    {
        { NODE, "add",           SEC_DEVELOPPER,    true,   &ChatHandler::HandleGroupAddSpellCommand,              "", nullptr},
        { NODE, "rule",          SEC_DEVELOPPER,    true,   &ChatHandler::HandleGroupSetRuleCommand,               "", nullptr},
    ...
    static ChatCommand accountCommandTable[] =
    {
        ...
        { NODE, "onlinelist",     SEC_ADMINISTRATOR,        true,  &ChatHandler::HandleAccountOnlineListCommand,   "", nullptr },
        { NODE, "lock",           SEC_MODERATOR,         true,  &ChatHandler::HandleAccountLockCommand,         "", nullptr },
    ...
    {
        { NODE, "alliance",       SEC_MODERATOR_CONF,  false, &ChatHandler::HandleAuctionAllianceCommand,     "", nullptr },
        { NODE, "goblin",         SEC_MODERATOR_CONF,  false, &ChatHandler::HandleAuctionGoblinCommand,       "", nullptr },
        { NODE, "horde",          SEC_MODERATOR_CONF,  false, &ChatHandler::HandleAuctionHordeCommand,        "", nullptr },
    ...
    static ChatCommand banCommandTable[] =
    {
        ...
        { NODE, "ip",             SEC_BASIC_ADMIN,  true,  &ChatHandler::HandleBanIPCommand,               "", nullptr },
        { NODE, "note",           SEC_MODERATOR_CONF,     true,  &ChatHandler::HandleAddCharacterNoteCommand,    "", nullptr },
        { NODE, "warn",           SEC_MODERATOR_CONF,     true,  &ChatHandler::HandleWarnCharacterCommand,       "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand baninfoCommandTable[] =
    {
        { NODE, "account",        SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleBanInfoAccountCommand,      "", nullptr },
        { NODE, "character",      SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleBanInfoCharacterCommand,    "", nullptr },
    ...
    {
        { NODE, "account",        SEC_DEVELOPPER,  true,  &ChatHandler::HandleBanListAccountCommand,      "", nullptr },
        { NODE, "character",      SEC_DEVELOPPER,  true,  &ChatHandler::HandleBanListCharacterCommand,    "", nullptr },
        { NODE, "ip",             SEC_DEVELOPPER,  true,  &ChatHandler::HandleBanListIPCommand,           "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand characterDeletedCommandTable[] =
    {
        ...
        { NODE, "restore",        SEC_GAMEMASTER,  true,  &ChatHandler::HandleCharacterDeletedRestoreCommand, "", nullptr },
    ...
    {
        { NODE, "todelete",       SEC_CONSOLE,  true,  &ChatHandler::HandleCleanCharactersToDeleteCommand,     "", nullptr },
        { NODE, "items",          SEC_CONSOLE,  true,  &ChatHandler::HandleCleanCharactersItemsCommand,        "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                                   "", nullptr }
    };
    ...
    static ChatCommand characterCommandTable[] =
    {
        ...
        { NODE, "reputation",     SEC_ADMINISTRATOR,     true,  &ChatHandler::HandleCharacterReputationCommand, "", nullptr },
        { NODE, "hasitem",        SEC_MODERATOR_CONF,     true,  &ChatHandler::HandleCharacterHasItemCommand,    "", nullptr },
        { NODE, "race",           SEC_CONSOLE,     true,  &ChatHandler::HandleCharacterChangeRaceCommand, "", nullptr },
        { NODE, "skin",           SEC_CONSOLE,     true,  &ChatHandler::HandleCharacterCopySkinCommand,   "", nullptr },
        { NODE, "fillflys",       SEC_CONSOLE,     true,  &ChatHandler::HandleCharacterFillFlysCommand,   "", nullptr },
        { NODE, "flags",          SEC_CONSOLE,     true,  &ChatHandler::HandleCharacterFlagsCommand,      "", nullptr },
        { NODE, "recup",          SEC_CONSOLE,  false, &ChatHandler::HandleRecupCommand,               "", nullptr },
        { NODE, "clean",          SEC_CONSOLE,  true, nullptr,                                           "", characterCleanCommandTable },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand debugCommandTable[] =
    {
        ...
        { NODE, "condition",      SEC_ADMINISTRATOR,  false, &ChatHandler::HandleDebugConditionCommand,           "", nullptr },
    ...
    {
        { NODE, "list",           SEC_ADMINISTRATOR,     true,  &ChatHandler::HandleEventListCommand,           "", nullptr },
        { NODE, "start",          SEC_ADMINISTRATOR,     true,  &ChatHandler::HandleEventStartCommand,          "", nullptr },
        { NODE, "stop",           SEC_ADMINISTRATOR,     true,  &ChatHandler::HandleEventStopCommand,           "", nullptr },
    ...
    {
        { NODE, "creature",       SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoCreatureCommand,          "", nullptr },
        { NODE, "graveyard",      SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoGraveyardCommand,         "", nullptr },
        { NODE, "grid",           SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoGridCommand,              "", nullptr },
        { NODE, "object",         SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoObjectCommand,            "", nullptr },
        { NODE, "taxinode",       SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoTaxinodeCommand,          "", nullptr },
        { NODE, "trigger",        SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoTriggerCommand,           "", nullptr },
        { NODE, "zonexy",         SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoZoneXYCommand,            "", nullptr },
        { NODE, "xy",             SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoXYCommand,                "", nullptr },
        { NODE, "xyz",            SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGoXYZCommand,               "", nullptr },
        ...
        // Battleground join
        { NODE, "warsong",        SEC_DEVELOPPER,         false, &ChatHandler::HandleGoWarsongCommand,           "", nullptr },
        { NODE, "arathi",         SEC_DEVELOPPER,         false, &ChatHandler::HandleGoArathiCommand,            "", nullptr },
        { NODE, "alterac",        SEC_DEVELOPPER,         false, &ChatHandler::HandleGoAlteracCommand,           "", nullptr },
    ...
    static ChatCommand gobjectCommandTable[] =
    {
        ...
        { NODE, "tmpadd",         SEC_ADMINISTRATOR,     false, &ChatHandler::HandleGameObjectTempAddCommand,   "", nullptr },
        { NODE, "delete",         SEC_DEVELOPPER,     false, &ChatHandler::HandleGameObjectDeleteCommand,    "", nullptr },
        { NODE, "move",           SEC_DEVELOPPER,     false, &ChatHandler::HandleGameObjectMoveCommand,      "", nullptr },
        { NODE, "near",           SEC_MODERATOR_CONF,     false, &ChatHandler::HandleGameObjectNearCommand,      "", nullptr },
        { NODE, "target",         SEC_MODERATOR_CONF,     false, &ChatHandler::HandleGameObjectTargetCommand,    "", nullptr },
        { NODE, "turn",           SEC_ADMINISTRATOR,     false, &ChatHandler::HandleGameObjectTurnCommand,      "", nullptr },
        { NODE, "select",         SEC_MODERATOR_CONF,  false, &ChatHandler::HandleGameObjectSelectCommand,    "", nullptr },
        { NODE, "despawn",        SEC_ADMINISTRATOR,  false, &ChatHandler::HandleGameObjectDespawnCommand,   "", nullptr },
        { NODE, "toggle",         SEC_MODERATOR_CONF,  false, &ChatHandler::HandleGameObjectToggleCommand,    "", nullptr },
        { NODE, "reset",          SEC_DEVELOPPER,  false, &ChatHandler::HandleGameObjectResetCommand,     "", nullptr },
        { NODE, "respawn",        SEC_DEVELOPPER,  false, &ChatHandler::HandleGameObjectRespawnCommand,   "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand guildCommandTable[] =
    {
        { NODE, "create",         SEC_DEVELOPPER,     true,  &ChatHandler::HandleGuildCreateCommand,         "", nullptr },
        { NODE, "delete",         SEC_BASIC_ADMIN,     true,  &ChatHandler::HandleGuildDeleteCommand,         "", nullptr },
        { NODE, "invite",         SEC_BASIC_ADMIN,     true,  &ChatHandler::HandleGuildInviteCommand,         "", nullptr },
        { NODE, "uninvite",       SEC_BASIC_ADMIN,     true,  &ChatHandler::HandleGuildUninviteCommand,       "", nullptr },
        { NODE, "rank",           SEC_BASIC_ADMIN,     true,  &ChatHandler::HandleGuildRankCommand,           "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand honorCommandTable[] =
    {
        ...
        { NODE, "show",           SEC_BASIC_ADMIN,     false, &ChatHandler::HandleHonorShow,                  "", nullptr },
        { NODE, "debug",          SEC_DEVELOPPER,  true,  &ChatHandler::HandleHonorDebugScoresCommand,    "", nullptr },
        { NODE, "setrp",          SEC_GAMEMASTER,  true,  &ChatHandler::HandleHonorSetRPCommand,          "", nullptr },
    ...
    static ChatCommand instanceCommandTable[] =
    {
        ...
        { NODE, "listbinds",      SEC_MODERATOR_CONF,  false, &ChatHandler::HandleInstanceListBindsCommand,   "", nullptr },
        { NODE, "unbind",         SEC_MODERATOR_CONF,  false, &ChatHandler::HandleInstanceUnbindCommand,      "", nullptr },
        { NODE, "stats",          SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleInstanceStatsCommand,       "", nullptr },
        { NODE, "savedata",       SEC_ADMINISTRATOR,  false, &ChatHandler::HandleInstanceSaveDataCommand,    "", nullptr },
        { NODE, "switch",         SEC_DEVELOPPER,  false, &ChatHandler::HandleInstanceSwitchCommand,      "", nullptr },
        { NODE, "perfinfos",      SEC_DEVELOPPER,  false, &ChatHandler::HandleInstancePerfInfosCommand,   "", nullptr },
    ...
    {
        { NODE, "all",            SEC_DEVELOPPER,  false, &ChatHandler::HandleLearnAllCommand,            "", nullptr },
        { NODE, "all_gm",         SEC_DEVELOPPER,     false, &ChatHandler::HandleLearnAllGMCommand,          "", nullptr },
        { NODE, "all_crafts",     SEC_DEVELOPPER,     false, &ChatHandler::HandleLearnAllCraftsCommand,      "", nullptr },
        { NODE, "all_default",    SEC_DEVELOPPER,      false, &ChatHandler::HandleLearnAllDefaultCommand,     "", nullptr },
        { NODE, "all_lang",       SEC_DEVELOPPER,      false, &ChatHandler::HandleLearnAllLangCommand,        "", nullptr },
        ...
        { NODE, "all_recipes",    SEC_DEVELOPPER,     false, &ChatHandler::HandleLearnAllRecipesCommand,     "", nullptr },
    ...
    {
        { NODE, "auras",          SEC_MODERATOR_CONF,  false, &ChatHandler::HandleListAurasCommand,           "", nullptr },
        { NODE, "creature",       SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleListCreatureCommand,        "", nullptr },
        { NODE, "item",           SEC_CONSOLE,  true,  &ChatHandler::HandleListItemCommand,            "", nullptr },
        { NODE, "object",         SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleListObjectCommand,          "", nullptr },
        { NODE, "talents",        SEC_MODERATOR_CONF,  false, &ChatHandler::HandleListTalentsCommand,         "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand lookupAccountCommandTable[] =
    {
        ...
        { NODE, "ip",             SEC_ADMINISTRATOR,     false,  &ChatHandler::HandleLookupAccountIpCommand,        "", nullptr },
        { NODE, "iponline",       SEC_GAMEMASTER,     false,  &ChatHandler::HandleLookupAccountIponlineCommand,  "", nullptr },
        { NODE, "name",           SEC_ADMINISTRATOR,     false,  &ChatHandler::HandleLookupAccountNameCommand,      "", nullptr },
        { MSTR, nullptr,          0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand lookupCommandTable[] =
    {
        ...
        { NODE, "creaturemodel",  SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleLookupCreatureModelCommand, "", nullptr },
        { NODE, "event",          SEC_MODERATOR_CONF,     true,  &ChatHandler::HandleLookupEventCommand,         "", nullptr },
        { NODE, "faction",        SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupFactionCommand,       "", nullptr },
        { NODE, "item",           SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupItemCommand,          "", nullptr },
        { NODE, "itemset",        SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupItemSetCommand,       "", nullptr },
        { NODE, "object",         SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupObjectCommand,        "", nullptr },
        { NODE, "quest",          SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupQuestCommand,         "", nullptr },
        { NODE, "player",         SEC_GAMEMASTER,     true, nullptr,                                           "", lookupPlayerCommandTable },
        { NODE, "pool",           SEC_MODERATOR_CONF,     true,  &ChatHandler::HandleLookupPoolCommand,          "", nullptr },
        { NODE, "skill",          SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupSkillCommand,         "", nullptr },
        { NODE, "spell",          SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupSpellCommand,         "", nullptr },
        { NODE, "sound",          SEC_MODERATOR_CONF,      true,  &ChatHandler::HandleLookupSoundCommand,         "", nullptr },
        { NODE, "taxinode",       SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleLookupTaxiNodeCommand,      "", nullptr },
        { NODE, "tele",           SEC_MODERATOR_CONF,      true,  &ChatHandler::HandleLookupTeleCommand,          "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand modifyCommandTable[] =
    {
        { NODE, "hp",             SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyHPCommand,            "", nullptr },
        { NODE, "mana",           SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyManaCommand,          "", nullptr },
        { NODE, "rage",           SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyRageCommand,          "", nullptr },
        { NODE, "energy",         SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyEnergyCommand,        "", nullptr },
        { NODE, "money",          SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyMoneyCommand,         "", nullptr },
        { NODE, "speed",          SEC_MODERATOR_CONF,      false, &ChatHandler::HandleModifySpeedCommand,         "", nullptr },
        { NODE, "swim",           SEC_MODERATOR_CONF,      false, &ChatHandler::HandleModifySwimCommand,          "", nullptr },
        { NODE, "scale",          SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyScaleCommand,         "", nullptr },
        { NODE, "bwalk",          SEC_MODERATOR_CONF,      false, &ChatHandler::HandleModifyBWalkCommand,         "", nullptr },
        { NODE, "fly",            SEC_MODERATOR,      false, &ChatHandler::HandleModifyFlyCommand,           "", nullptr },
        { NODE, "aspeed",         SEC_MODERATOR_CONF,      false, &ChatHandler::HandleModifyASpeedCommand,        "", nullptr },
        { NODE, "faction",        SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyFactionCommand,       "", nullptr },
        { NODE, "tp",             SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyTalentCommand,        "", nullptr },
        { NODE, "mount",          SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyMountCommand,         "", nullptr },
        { NODE, "honor",          SEC_ADMINISTRATOR,      false, &ChatHandler::HandleModifyHonorCommand,         "", nullptr },
        { NODE, "rep",            SEC_DEVELOPPER,     false, &ChatHandler::HandleModifyRepCommand,           "", nullptr },
        { NODE, "drunk",          SEC_DEVELOPPER,      false, &ChatHandler::HandleModifyDrunkCommand,         "", nullptr },
        { NODE, "standstate",     SEC_DEVELOPPER,     false, &ChatHandler::HandleModifyStandStateCommand,    "", nullptr },
        { NODE, "morph",          SEC_DEVELOPPER,     false, &ChatHandler::HandleModifyMorphCommand,         "", nullptr },
        { NODE, "gender",         SEC_DEVELOPPER,     false, &ChatHandler::HandleModifyGenderCommand,        "", nullptr },
    ...
    static ChatCommand npcCommandTable[] =
    {
        ...
        { NODE, "changeentry",    SEC_DEVELOPPER,  false, &ChatHandler::HandleNpcChangeEntryCommand,      "", nullptr },
        { NODE, "changelevel",    SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcChangeLevelCommand,      "", nullptr },
        ...
        { NODE, "factionid",      SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcFactionIdCommand,        "", nullptr },
        { NODE, "flag",           SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcFlagCommand,             "", nullptr },
        { NODE, "follow",         SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcFollowCommand,           "", nullptr },
        { NODE, "info",           SEC_BASIC_ADMIN,  false, &ChatHandler::HandleNpcInfoCommand,             "", nullptr },
        { NODE, "move",           SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcMoveCommand,             "", nullptr },
        { NODE, "playemote",      SEC_DEVELOPPER,  false, &ChatHandler::HandleNpcPlayEmoteCommand,        "", nullptr },
        { NODE, "setmodel",       SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcSetModelCommand,         "", nullptr },
        { NODE, "setmovetype",    SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcSetMoveTypeCommand,      "", nullptr },
        { NODE, "spawndist",      SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcSpawnDistCommand,        "", nullptr },
        { NODE, "spawntime",      SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcSpawnTimeCommand,        "", nullptr },
        { NODE, "say",            SEC_BASIC_ADMIN,      false, &ChatHandler::HandleNpcSayCommand,              "", nullptr },
        { NODE, "summon",         SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcSummonCommand,           "", nullptr },
        { NODE, "textemote",      SEC_BASIC_ADMIN,      false, &ChatHandler::HandleNpcTextEmoteCommand,        "", nullptr },
        { NODE, "unfollow",       SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcUnFollowCommand,         "", nullptr },
        { NODE, "whisper",        SEC_BASIC_ADMIN,      false, &ChatHandler::HandleNpcWhisperCommand,          "", nullptr },
        { NODE, "yell",           SEC_BASIC_ADMIN,      false, &ChatHandler::HandleNpcYellCommand,             "", nullptr },
        { NODE, "tame",           SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcTameCommand,             "", nullptr },
        ...
        { NODE, "addweapon",      SEC_DEVELOPPER,  false, &ChatHandler::HandleNpcAddWeaponCommand,        "", nullptr },
        { NODE, "name",           SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcNameCommand,             "", nullptr },
        { NODE, "subname",        SEC_DEVELOPPER,     false, &ChatHandler::HandleNpcSubNameCommand,          "", nullptr },
        //}
    ...
    {
        { MSTR, "stats",          SEC_DEVELOPPER,  true,  &ChatHandler::HandlePBCastStatsCommand,         "", nullptr },
        { MSTR, "setthreads",     SEC_DEVELOPPER,  true,  &ChatHandler::HandlePBCastSetThreadsCommand,    "", nullptr },
        { MSTR, nullptr,             0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand pdumpCommandTable[] =
    {
        { NODE, "load",           SEC_DEVELOPPER,  true,  &ChatHandler::HandlePDumpLoadCommand,           "", nullptr },
        { NODE, "write",          SEC_DEVELOPPER,  true,  &ChatHandler::HandlePDumpWriteCommand,          "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand poolCommandTable[] =
    {
        { NODE, "list",           SEC_DEVELOPPER,     false, &ChatHandler::HandlePoolListCommand,            "", nullptr },
        { NODE, "update",         SEC_DEVELOPPER,  false, &ChatHandler::HandlePoolUpdateCommand,          "", nullptr },
        { NODE, "spawns",         SEC_DEVELOPPER,     false, &ChatHandler::HandlePoolSpawnsCommand,          "", nullptr },
        { NODE, "",               SEC_DEVELOPPER,     true,  &ChatHandler::HandlePoolInfoCommand,            "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand questCommandTable[] =
    {
        ...
        { NODE, "status",         SEC_MODERATOR_CONF,  false, &ChatHandler::HandleQuestStatusCommand,         "", nullptr },
        { NODE, "remove",         SEC_BASIC_ADMIN,  false, &ChatHandler::HandleQuestRemoveCommand,         "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    static ChatCommand petCommandTable[] =
    {
        ...
        { MSTR, "delete",         SEC_BASIC_ADMIN,  true,  &ChatHandler::HandlePetDeleteCommand,            "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                            "", nullptr }
    };

    static ChatCommand reloadCommandTable[] =
    {
        { MSTR, "all",            SEC_CONSOLE,  true,  &ChatHandler::HandleReloadAllCommand,           "", nullptr },
        { MSTR, "all_area",       SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllAreaCommand,       "", nullptr },
        { MSTR, "all_gossips",    SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllGossipsCommand,    "", nullptr },
        { MSTR, "all_item",       SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllItemCommand,       "", nullptr },
        { MSTR, "all_locales",    SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllLocalesCommand,    "", nullptr },
        { MSTR, "all_loot",       SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllLootCommand,       "", nullptr },
        { MSTR, "all_npc",        SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllNpcCommand,        "", nullptr },
        { MSTR, "all_quest",      SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllQuestCommand,      "", nullptr },
        { MSTR, "all_scripts",    SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllScriptsCommand,    "", nullptr },
        { MSTR, "all_spell",      SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadAllSpellCommand,      "", nullptr },

        { MSTR, "anticheat",      SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleReloadAnticheatCommand,     "", nullptr },
        { MSTR, "config",         SEC_DEVELOPPER,  true,  &ChatHandler::HandleReloadConfigCommand,        "", nullptr },
        ...
        { MSTR, "command",                     SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadCommandCommand,                 "", nullptr },
        ...
        { MSTR, "creature_ai_events",          SEC_ADMINISTRATOR, true, &ChatHandler::HandleReloadEventAIEventsCommand,         "", nullptr },
        ...
        { MSTR, "creature_spells_scripts",     SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadCreatureSpellScriptsCommand,    "", nullptr },
        ...
        { MSTR, "reserved_name",               SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadReservedNameCommand,            "", nullptr },
        ...
        { MSTR, "skill_discovery_template",    SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadSkillDiscoveryTemplateCommand,  "", nullptr },
        { MSTR, "skill_extra_item_template",   SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadSkillExtraItemTemplateCommand,  "", nullptr },
        ...
        { MSTR, "autobroadcast",               SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadAutoBroadcastCommand,           "", nullptr },
        ...
        { MSTR, "ip_banned",                   SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadIPBanList,                      "", nullptr },
        { MSTR, "account_banned",              SEC_DEVELOPPER, true,  &ChatHandler::HandleReloadAccountBanList,                 "", nullptr },
    ...
    static ChatCommand sendCommandTable[] =
    {
        ...
        { MSTR, "items",          SEC_BASIC_ADMIN,  true,  &ChatHandler::HandleSendItemsCommand,           "", nullptr },
    ...
    {
        { NODE, "cancel",         SEC_DEVELOPPER,  true,  &ChatHandler::HandleServerShutDownCancelCommand, "", nullptr },
        { NODE, ""   ,            SEC_DEVELOPPER,  true,  &ChatHandler::HandleServerIdleRestartCommand,   "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    {
        { NODE, "cancel",         SEC_DEVELOPPER,  true,  &ChatHandler::HandleServerShutDownCancelCommand, "", nullptr },
        { NODE, ""   ,            SEC_DEVELOPPER,  true,  &ChatHandler::HandleServerIdleShutDownCommand,  "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    {
        { NODE, "filter",         SEC_DEVELOPPER,        true,  &ChatHandler::HandleServerLogFilterCommand,     "", nullptr },
        { NODE, "level",          SEC_DEVELOPPER,        true,  &ChatHandler::HandleServerLogLevelCommand,      "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    {
        { NODE, "corpses",        SEC_DEVELOPPER,     true,  &ChatHandler::HandleServerCorpsesCommand,       "", nullptr },
        { NODE, "exit",           SEC_ADMINISTRATOR,        true,  &ChatHandler::HandleServerExitCommand,          "", nullptr },
        { NODE, "idlerestart",    SEC_DEVELOPPER,  true, nullptr,                                           "", serverIdleRestartCommandTable },
        ...
        { NODE, "log",            SEC_DEVELOPPER,        true, nullptr,                                           "", serverLogCommandTable },
        ...
        { NODE, "restart",        SEC_DEVELOPPER,  true, nullptr,                                           "", serverRestartCommandTable },
    ...
    {
        { NODE, "add",            SEC_GAMEMASTER,  false, &ChatHandler::HandleTeleAddCommand,             "", nullptr },
        { NODE, "del",            SEC_DEVELOPPER,  true,  &ChatHandler::HandleTeleDelCommand,             "", nullptr },
        { NODE, "name",           SEC_GAMEMASTER,      true,  &ChatHandler::HandleTeleNameCommand,            "", nullptr },
        { NODE, "group",          SEC_GAMEMASTER,      false, &ChatHandler::HandleTeleGroupCommand,           "", nullptr },
        { NODE, "",               SEC_MODERATOR_CONF,      false, &ChatHandler::HandleTeleCommand,                "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand triggerCommandTable[] =
    {
        { NODE, "active",         SEC_DEVELOPPER,     false, &ChatHandler::HandleTriggerActiveCommand,       "", nullptr },
        { NODE, "near",           SEC_DEVELOPPER,     false, &ChatHandler::HandleTriggerNearCommand,         "", nullptr },
        { NODE, "",               SEC_DEVELOPPER,     true,  &ChatHandler::HandleTriggerCommand,             "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand unbanCommandTable[] =
    {
        { NODE, "account",        SEC_BASIC_ADMIN,  true,  &ChatHandler::HandleUnBanAccountCommand,      "", nullptr },
        { NODE, "character",      SEC_BASIC_ADMIN,  true,  &ChatHandler::HandleUnBanCharacterCommand,    "", nullptr },
        { NODE, "ip",             SEC_BASIC_ADMIN,  true,  &ChatHandler::HandleUnBanIPCommand,           "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand wpCommandTable[] =
    {
        { NODE, "show",           SEC_DEVELOPPER,     false, &ChatHandler::HandleWpShowCommand,              "", nullptr },
        ...
        { NODE, "export",         SEC_DEVELOPPER,  false, &ChatHandler::HandleWpExportCommand,            "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };
    ...
    {
        { NODE, "test",              SEC_DEVELOPPER,        false, &ChatHandler::HandleUpdateWorldStateCommand, "", nullptr},
        { MSTR, nullptr,          0,                        false, nullptr,                                        "", nullptr}
    };
    static ChatCommand bgCommandTable[] =
    {
        { NODE, "status",            SEC_DEVELOPPER,           false, &ChatHandler::HandleBGStatusCommand,         "", nullptr},
        { NODE, "start",             SEC_DEVELOPPER,           false, &ChatHandler::HandleBGStartCommand,          "", nullptr},
        { NODE, "stop",              SEC_DEVELOPPER,           false, &ChatHandler::HandleBGStopCommand,           "", nullptr},
        { NODE, "",                  SEC_DEVELOPPER,           false, &ChatHandler::HandleBGCustomCommand,         "", nullptr},
        { MSTR, nullptr,          0,                        false, nullptr,                                        "", nullptr}
    };
    static ChatCommand spellCommandTable[] =
    {
        { NODE, "effects",           SEC_DEVELOPPER,           true, &ChatHandler::HandleSpellEffectsCommand,      "", nullptr},
        { NODE, "info",              SEC_DEVELOPPER,           true, &ChatHandler::HandleSpellInfosCommand,        "", nullptr},
        { NODE, "search",            SEC_DEVELOPPER,           true, &ChatHandler::HandleSpellSearchCommand,       "", nullptr},
        { NODE, "iconfix",           SEC_ADMINISTRATOR,        true, &ChatHandler::HandleSpellIconFixCommand,      "", nullptr},
        { MSTR, nullptr,          0,                        false, nullptr,                                        "", nullptr}
    };
    static ChatCommand mmapCommandTable[] =
    {
        { NODE, "path",           SEC_DEVELOPPER,     false, &ChatHandler::HandleMmapPathCommand,            "", nullptr },
        { NODE, "loc",            SEC_DEVELOPPER,     false, &ChatHandler::HandleMmapLocCommand,             "", nullptr },
        { NODE, "loadedtiles",    SEC_DEVELOPPER,     false, &ChatHandler::HandleMmapLoadedTilesCommand,     "", nullptr },
        { NODE, "stats",          SEC_DEVELOPPER,     false, &ChatHandler::HandleMmapStatsCommand,           "", nullptr },
        { NODE, "testarea",       SEC_DEVELOPPER,     false, &ChatHandler::HandleMmapTestArea,               "", nullptr },
        { NODE, "connect",        SEC_DEVELOPPER,  false, &ChatHandler::HandleMmapConnection,             "", nullptr },
        { NODE, "reload",         SEC_DEVELOPPER,  false, &ChatHandler::HandleMmapLoad,                   "", nullptr },
        { NODE, "unload",         SEC_DEVELOPPER,  false, &ChatHandler::HandleMmapUnload,                 "", nullptr },
        { NODE, "",               SEC_DEVELOPPER,  false, &ChatHandler::HandleMmap,                       "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand videosCommandTable[] =
    {
        { NODE, "expendables",    SEC_DEVELOPPER,     false, &ChatHandler::HandleDebugExp,                   "", nullptr },
        { NODE, "turn",           SEC_DEVELOPPER,     false, &ChatHandler::HandleVideoTurn,                  "", nullptr },
        { NODE, "",               SEC_DEVELOPPER,     false, &ChatHandler::HandleDebugExp,                   "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand anticheatClientCommandTable[] =
    {
        { NODE, "find",           SEC_DEVELOPPER,     true,  &ChatHandler::HandleClientSearchCommand,        "", nullptr },
        { NODE, "",               SEC_DEVELOPPER,     true,  &ChatHandler::HandleClientInfosCommand,         "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                           "", nullptr }
    };

    static ChatCommand anticheatWardenCommandTable[] =
    {
        { NODE, "read",     SEC_DEVELOPPER,  false, &ChatHandler::HandleWardenReadCommand,           "", nullptr },
        { NODE, "",         SEC_DEVELOPPER,  true,  &ChatHandler::HandleWardenCommand,               "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                            "", nullptr }
    };

    static ChatCommand anticheatCommandTable[] =
    {
        { NODE, "server",         SEC_DEVELOPPER,     true,  &ChatHandler::HandleAnticheatCommand,      "", nullptr },
        { NODE, "warden",         SEC_DEVELOPPER,     true, nullptr,                                      "", anticheatWardenCommandTable },
        { NODE, "client",         SEC_DEVELOPPER,  true, nullptr,                                      "", anticheatClientCommandTable },
        { MSTR, nullptr,       0,                  false, nullptr,                                            "", nullptr }
    };
    static ChatCommand replayCommandTable[] =
    {
        { NODE, "play",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleReplayPlayCommand,           "", nullptr },
        { NODE, "forward",        SEC_BASIC_ADMIN,  false, &ChatHandler::HandleReplayForwardCommand,        "", nullptr },
        { NODE, "stop",           SEC_BASIC_ADMIN,  false, &ChatHandler::HandleReplayStopCommand,           "", nullptr },
        { NODE, "record",         SEC_BASIC_ADMIN,  false, &ChatHandler::HandleReplayRecordCommand,         "", nullptr },
    ...
    {
        { NODE, "join",           SEC_ADMINISTRATOR,     false, &ChatHandler::HandleChannelJoinCommand,          "", nullptr },
        { NODE, "leave",          SEC_ADMINISTRATOR,     false, &ChatHandler::HandleChannelLeaveCommand,         "", nullptr },
        { MSTR, nullptr,       0,                  false, nullptr,                                            "", nullptr }
    };
    static ChatCommand ticketResponseCommandTable[] =
    {
        { NODE, "reset",    SEC_MODERATOR,           true,  &ChatHandler::HandleGMTicketResponseResetCommand,    "", nullptr },
        { NODE, "append",   SEC_MODERATOR,           true,  &ChatHandler::HandleGMTicketResponseAppendCommand,   "", nullptr },
        { NODE, "appendln", SEC_MODERATOR,           true,  &ChatHandler::HandleGMTicketResponseAppendLnCommand, "", nullptr },
        { MSTR, nullptr, 0,                        false, nullptr,                                                "", nullptr }
    };
    ...
    {
        { NODE, "assign",        SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketAssignToCommand,          "", nullptr },
        { NODE, "close",         SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketCloseByIdCommand,         "", nullptr },
        { NODE, "closedlist",    SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketListClosedCommand,        "", nullptr },
        { NODE, "counter",       SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketCounterCommand,           "", nullptr },
        { NODE, "comment",       SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketCommentCommand,           "", nullptr },
        { NODE, "complete",      SEC_ADMINISTRATOR,      true, &ChatHandler::HandleGMTicketCompleteCommand,          "", nullptr },
        { NODE, "delete",        SEC_ADMINISTRATOR,      true, &ChatHandler::HandleGMTicketDeleteByIdCommand,        "", nullptr },
        { NODE, "escalate",      SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketEscalateCommand,          "", nullptr },
        { NODE, "escalatedlist", SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketListEscalatedCommand,     "", nullptr },
        { NODE, "list",          SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketListCommand,              "", nullptr },
        { NODE, "next",          SEC_MODERATOR,      false,&ChatHandler::HandleGMTicketNextCommand,              "", nullptr },
        { NODE, "notify",        SEC_MODERATOR,      false,&ChatHandler::HandleGMTicketNotifyCommand,            "", nullptr },
        { NODE, "onlinelist",    SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketListOnlineCommand,        "", nullptr },
        { NODE, "previous",      SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketPreviousCommand,          "", nullptr },
        { NODE, "reload",        SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketReloadCommand,            "", nullptr },
        { NODE, "reset",         SEC_DEVELOPPER,      true, &ChatHandler::HandleGMTicketResetCommand,             "", nullptr },
        { NODE, "response",      SEC_MODERATOR,      true, nullptr,                           "", ticketResponseCommandTable },
        { NODE, "togglesystem",  SEC_ADMINISTRATOR,      true, &ChatHandler::HandleToggleGMTicketSystem,             "", nullptr },
        { NODE, "unassign",      SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketUnAssignCommand,          "", nullptr },
        { NODE, "viewid",        SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketGetByIdCommand,           "", nullptr },
        { NODE, "viewname",      SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketGetByNameCommand,         "", nullptr },
        { NODE, "",              SEC_MODERATOR,      true, &ChatHandler::HandleGMTicketGetByIdOrNameCommand,     "", nullptr },
        { MSTR, nullptr,      0,                   false,nullptr,                                                 "", nullptr }
    };
    ...
    {
        { MSTR, "mute",               SEC_MODERATOR_CONF,       true,  &ChatHandler::HandleSpamerMute,                "", nullptr },
        { MSTR, "unmute",             SEC_MODERATOR_CONF,       true,  &ChatHandler::HandleSpamerUnmute,              "", nullptr },
        { MSTR, "list",               SEC_MODERATOR_CONF,       true,  &ChatHandler::HandleSpamerList,                "", nullptr },
        { MSTR, nullptr,              0,                    false, nullptr,                                       "", nullptr }
    };
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { NODE, "replay",         SEC_DEVELOPPER,     false, nullptr,                                           "", replayCommandTable   },
        ...
        { NODE, "gobject",        SEC_DEVELOPPER,     false, nullptr,                                           "", gobjectCommandTable  },
        ...
        { NODE, "learn",          SEC_DEVELOPPER,      false, nullptr,                                           "", learnCommandTable    },
        { NODE, "list",           SEC_DEVELOPPER,  true, nullptr,                                           "", listCommandTable     },
        { NODE, "lookup",         SEC_MODERATOR_CONF,      true, nullptr,                                           "", lookupCommandTable   },
        { NODE, "modify",         SEC_BASIC_ADMIN,      false, nullptr,                                           "", modifyCommandTable   },
        { NODE, "npc",            SEC_MODERATOR,      false, nullptr,                                           "", npcCommandTable      },
        { NODE, "pool",           SEC_DEVELOPPER,     true, nullptr,                                           "", poolCommandTable     },
        { NODE, "pdump",          SEC_DEVELOPPER,  true, nullptr,                                           "", pdumpCommandTable    },
        { NODE, "quest",          SEC_MODERATOR_CONF,  false, nullptr,                                           "", questCommandTable    },
        ...
        { NODE, "tele",           SEC_MODERATOR_CONF,      true, nullptr,                                           "", teleCommandTable     },
        { NODE, "trigger",        SEC_DEVELOPPER,     false, nullptr,                                           "", triggerCommandTable  },
        { NODE, "wp",             SEC_DEVELOPPER,     false, nullptr,                                           "", wpCommandTable       },
        ...
        { NODE, "possess",        SEC_DEVELOPPER,     false, &ChatHandler::HandlePossessCommand,             "", nullptr},
        { NODE, "cinematic",      SEC_DEVELOPPER,     false, nullptr,                                           "", cinematicCommandTable},
        { NODE, "escorte",        SEC_ADMINISTRATOR,     false, nullptr,                                           "", escortCommandTable},
        { NODE, "worldstate",     SEC_DEVELOPPER,     false, nullptr,                                           "", worldStateCommandTable},
        { NODE, "bg",             SEC_DEVELOPPER,     false, nullptr,                                           "", bgCommandTable},
        { NODE, "spell",          SEC_DEVELOPPER,     true, nullptr,                                           "", spellCommandTable},
        { NODE, "variable",       SEC_DEVELOPPER,     true,  &ChatHandler::HandleVariableCommand,            "", nullptr},
        { NODE, "god",            SEC_DEVELOPPER,     false, &ChatHandler::HandleGodCommand,                 "", nullptr },
        { NODE, "aura",           SEC_DEVELOPPER,  false, &ChatHandler::HandleAuraCommand,                "", nullptr },
        { NODE, "unaura",         SEC_MODERATOR_CONF,  false, &ChatHandler::HandleUnAuraCommand,              "", nullptr },
        ...
        { NODE, "groupgo",        SEC_GAMEMASTER,      false, &ChatHandler::HandleGroupgoCommand,             "", nullptr },
        ...
        { NODE, "demorph",        SEC_DEVELOPPER,     false, &ChatHandler::HandleDeMorphCommand,             "", nullptr },
        ...
        { NODE, "revive",         SEC_MODERATOR_CONF,  true,  &ChatHandler::HandleReviveCommand,              "", nullptr },
        { NODE, "dismount",       SEC_ADMINISTRATOR,         false, &ChatHandler::HandleDismountCommand,            "", nullptr },
        { NODE, "gps",            SEC_MODERATOR_CONF,      false, &ChatHandler::HandleGPSCommand,                 "", nullptr },
        { NODE, "guid",           SEC_MODERATOR_CONF,     false, &ChatHandler::HandleGUIDCommand,                "", nullptr },
        { NODE, "help",           SEC_PLAYER,         true,  &ChatHandler::HandleHelpCommand,                "", nullptr },
        { NODE, "itemmove",       SEC_DEVELOPPER,     false, &ChatHandler::HandleItemMoveCommand,            "", nullptr },
        ...
        { NODE, "distance",       SEC_MODERATOR_CONF,  false, &ChatHandler::HandleGetDistanceCommand,         "", nullptr },
        { NODE, "angle",          SEC_MODERATOR_CONF,  false, &ChatHandler::HandleGetAngleCommand,            "", nullptr },
        { NODE, "recall",         SEC_MODERATOR_CONF,      false, &ChatHandler::HandleRecallCommand,              "", nullptr },
        ...
        { MSTR, "saveall",        SEC_DEVELOPPER,      true,  &ChatHandler::HandleSaveAllCommand,             "", nullptr },
        { MSTR, "kick",           SEC_MODERATOR_CONF,     true,  &ChatHandler::HandleKickPlayerCommand,          "", nullptr },
        { MSTR, "ban",            SEC_MODERATOR_CONF,  true, nullptr,                                           "", banCommandTable      },
        { MSTR, "unban",          SEC_BASIC_ADMIN,  true, nullptr,                                           "", unbanCommandTable    },
        { MSTR, "baninfo",        SEC_MODERATOR_CONF,  false, nullptr,                                           "", baninfoCommandTable  },
        { MSTR, "banlist",        SEC_DEVELOPPER,  true, nullptr,                                           "", banlistCommandTable  },
        { NODE, "start",          SEC_ADMINISTRATOR,         false, &ChatHandler::HandleStartCommand,               "", nullptr },
        { NODE, "unstuck",        SEC_PLAYER,         false, &ChatHandler::HandleUnstuckCommand,             "", nullptr },
        { NODE, "taxicheat",      SEC_DEVELOPPER,      false, &ChatHandler::HandleTaxiCheatCommand,           "", nullptr },
        { NODE, "linkgrave",      SEC_DEVELOPPER,  false, &ChatHandler::HandleLinkGraveCommand,           "", nullptr },
        { NODE, "neargrave",      SEC_DEVELOPPER,  false, &ChatHandler::HandleNearGraveCommand,           "", nullptr },
        { NODE, "explorecheat",   SEC_DEVELOPPER,  false, &ChatHandler::HandleExploreCheatCommand,        "", nullptr },
        { NODE, "hover",          SEC_DEVELOPPER,  false, &ChatHandler::HandleHoverCommand,               "", nullptr },
        { NODE, "levelup",        SEC_DEVELOPPER,  false, &ChatHandler::HandleLevelUpCommand,             "", nullptr },
        { NODE, "showarea",       SEC_DEVELOPPER,  false, &ChatHandler::HandleShowAreaCommand,            "", nullptr },
        { NODE, "hidearea",       SEC_DEVELOPPER,  false, &ChatHandler::HandleHideAreaCommand,            "", nullptr },
        { NODE, "additem",        SEC_BASIC_ADMIN,  false, &ChatHandler::HandleAddItemCommand,             "", nullptr },
        { NODE, "deleteitem",     SEC_BASIC_ADMIN,  false, &ChatHandler::HandleDeleteItemCommand,          "", nullptr },
        { NODE, "additemset",     SEC_ADMINISTRATOR,  false, &ChatHandler::HandleAddItemSetCommand,          "", nullptr },
        { NODE, "bank",           SEC_GAMEMASTER,  false, &ChatHandler::HandleBankCommand,                "", nullptr },
        { NODE, "wchange",        SEC_BASIC_ADMIN,  false, &ChatHandler::HandleChangeWeatherCommand,       "", nullptr },
        { NODE, "ticket",         SEC_MODERATOR,     true, nullptr,                                           "",ticketCommandTable },
        { NODE, "maxskill",       SEC_DEVELOPPER,  false, &ChatHandler::HandleMaxSkillCommand,            "", nullptr },
        { NODE, "setskill",       SEC_DEVELOPPER,  false, &ChatHandler::HandleSetSkillCommand,            "", nullptr },
        ...
        { MSTR, "pinfo",          SEC_MODERATOR_CONF,     false, &ChatHandler::HandlePInfoCommand,               "", nullptr },
        ...
        { NODE, "mute",           SEC_MODERATOR_CONF,      true,  &ChatHandler::HandleMuteCommand,                "", nullptr },
        { NODE, "unmute",         SEC_MODERATOR_CONF,      true,  &ChatHandler::HandleUnmuteCommand,              "", nullptr },
        { NODE, "movegens",       SEC_DEVELOPPER,  false, &ChatHandler::HandleMovegensCommand,            "", nullptr },
        { NODE, "cometome",       SEC_DEVELOPPER,  false, &ChatHandler::HandleComeToMeCommand,            "", nullptr },
        { NODE, "damage",         SEC_DEVELOPPER,  false, &ChatHandler::HandleDamageCommand,              "", nullptr },
        { NODE, "combatstop",     SEC_MODERATOR_CONF,     false, &ChatHandler::HandleCombatStopCommand,          "", nullptr },
        { NODE, "repairitems",    SEC_ADMINISTRATOR,     true,  &ChatHandler::HandleRepairitemsCommand,         "", nullptr },
        { NODE, "stable",         SEC_DEVELOPPER,  false, &ChatHandler::HandleStableCommand,              "", nullptr },
        { NODE, "waterwalk",      SEC_MODERATOR_CONF,     false, &ChatHandler::HandleWaterwalkCommand,           "", nullptr },
        { NODE, "quit",           SEC_DEVELOPPER,        true,  &ChatHandler::HandleQuitCommand,                "", nullptr },
        { NODE, "mmap",           SEC_DEVELOPPER,     false, nullptr,                                           "", mmapCommandTable },
        { NODE, "video",          SEC_DEVELOPPER,     false, nullptr,                                           "", videosCommandTable },
        { NODE, "freez",          SEC_DEVELOPPER,     false, &ChatHandler::HandleFreezCommand,               "", nullptr },
        { NODE, "anticheat",      SEC_GAMEMASTER,     false, nullptr,                                           "", anticheatCommandTable },
        { NODE, "groupspell",     SEC_DEVELOPPER,  true, nullptr,                                           "", groupSpellCommandTable},
        { NODE, "pet",            SEC_MODERATOR_CONF,  true, nullptr,                                           "", petCommandTable},
        ...
        { MSTR, "runtest",        SEC_DEVELOPPER,  true,  &ChatHandler::HandleRunTestCommand,             "", nullptr },
        { MSTR, "log",            SEC_ADMINISTRATOR,     true,  &ChatHandler::HandleViewLogCommand,             "", nullptr },
        { MSTR, "spamer",         SEC_MODERATOR_CONF,     true, nullptr,                                           "", spamerCommandTable },
